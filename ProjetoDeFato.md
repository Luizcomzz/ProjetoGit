...
* criar uma pasta no github "Não sei se vai precisar fazer isso todas as vezes"
* git remote add origin "link.git" (permitir acesso remoto do projeto)
...
* git clone "link.git" (para copiar um arquivo de alguem)
* git pull (pega as atualizações feitas)
* caso queira adicionar o projeto dos outros nno git hub utiliza o botão (fork)